...
horseshoe_path = PlotPath(np.array([[0.74023, 0.26172],
                                [0.53262, 0.46934],
                                [0.39414, 0.60195],
                                [0.30527, 0.69082],
                                [0.22871, 0.76738],
...
class ICCProfile:
    ...
    def __init__(self, icc_path: PlotPath | str):
        self.icc_path = str(icc_path)
...
def plot_xy_coordinates_with_color(xy_array, output_path: Path | str):
